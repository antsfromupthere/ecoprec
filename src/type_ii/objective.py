"""Sum-rate objective for the direct-w method."""
...
class ObjectiveValue:
    ...
    continuous_rate: torch.Tensor | None
    ...
    def scalars(self) -> dict[str, float]:
        ...
        if self.continuous_rate is not None:
            result["continuous_rate"] = float(self.continuous_rate.detach())
...
def direct_w_objective(
    ...
    *,
    ...
    continuous_rate = (
        compute_sum_rate(channels, output.v_continuous, noise_power).mean()
