"""Standalone trainer for Type-I FSQ with shared Transformer weights.
    python -m type_i.train --epochs 2 --batches-per-epoch 2
"""
    ...
    *,
    ...
    if compute_diagnostics:
        result.update(
            ...
            beam_margin=float(output.beam_margin.mean()),
...
def train(
    ...
    *,
    ...
    """Train and return a JSON-serializable Type-I run record."""
    ...
    for epoch in range(train_cfg.epochs):
        ...
        if (epoch + 1) % train_cfg.eval_every == 0 \
            ...
            metrics.update(
                ...
                train_loss=(
                    float(running.loss.detach()) if running else None),
                train_soft_rate=(
